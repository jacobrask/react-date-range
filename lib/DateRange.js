...
var DateRange = (function (_Component) {
  ...
  function DateRange(props, context) {
    ...
    var startDate = props.startDate && (0, _utilsParseInputJs2['default'])(props.startDate, format, 'startOf');
    var endDate = props.startDate && (0, _utilsParseInputJs2['default'])(props.endDate, format, 'endOf');
  ...
  _createClass(DateRange, [{
    ...
    value: function componentWillReceiveProps(newProps) {
      ...
      if (newProps.startDate || newProps.endDate) {
        ...
        var startDateDidChange = (!startDate || !oldStartDate) && startDate !== oldStartDate || startDate && !startDate.isSame(oldStartDate);
        var endDateDidChange = (!endDate || !oldEndDate) && endDate !== oldEndDate || endDate && !endDate.isSame(oldEndDate);
